...
PlacedCubeAsset::~PlacedCubeAsset() {
}

/**
 * return position of floor
**/
glm::vec3 PlacedCubeAsset::getPos(){
	return pos;
}
...
**/
void PlacedCubeAsset::Draw(GLuint program_token) {
  ...
  GLuint anim_location = glGetUniformLocation(program_token, "Anim");
   //animate
   angle += 0.02f;
   anim = glm::rotate(glm::mat4(0.5), angle, glm::vec3(pos.x, pos.y, pos.z));
