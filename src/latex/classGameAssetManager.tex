...
\subsubsection[{\texorpdfstring{check\+Collision(glm\+::vec3)}{checkCollision(glm::vec3)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Game\+Asset\+Manager\+::check\+Collision (
\begin{DoxyParamCaption}
\item[{glm\+::vec3}]{p}
\end{DoxyParamCaption}
)}\hypertarget{classGameAssetManager_a6e08b31a22ecb815a8c1fe3a6dd463ed}{}\label{classGameAssetManager_a6e08b31a22ecb815a8c1fe3a6dd463ed}
Check for collisions with camera by comparing generated min and max points of camera with each cube. \index{Game\+Asset\+Manager@{Game\+Asset\+Manager}!Draw@{Draw}}
